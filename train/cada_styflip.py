...
if __name__ == "__main__":
    ...
    parser.add_argument('--catal', action='store_true', help='whether to align categorical domain and balanced sampling on the source domain')
    ...
    parser.add_argument('--aug_num', type=int, default=1, help="the number of augmentation samples")

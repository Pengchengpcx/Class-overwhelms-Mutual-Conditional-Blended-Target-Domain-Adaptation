...
if __name__ == "__main__":
    ...
    parser.add_argument('--catal', action='store_true', help='whether to use categorical balanced sampling on the source, if so, actual bs=batch_size * class_number')
    ...
    parser.add_argument('--rand_aug', action='store_true', help='whether to use rand augmentation')
    parser.add_argument('--aug_num', type=int, default=1, help="the number of extra augmented samples")
    parser.add_argument('--sub_log', type=str, default='', help="name of the output log file")
